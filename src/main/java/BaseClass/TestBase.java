...
public abstract class TestBase {
	...
	public static void screenShot(String name) {
		...
		File destination = new File("C:\\Users\\MONESH\\eclipse-workspace\\Cucumber\\Screenshots\\"+name+".png");
		try {
	...
	public static void explicityWaitAlert(Duration seconds,String value) {
	...
	public static void explicityWaitWebelement(WebElement element,Duration seconds,String value) {
